...
<head>
	...
	<title>{{$metaData->title ?? 'Оптовые покупатели. Сервис поиска покупателей оптом в России.'}}</title>
	<!-- Meta data -->
	<meta name="title"
		  content="{{$metaData->title ?? 'Оптовые покупатели. Сервис поиска покупателей оптом в России.'}}">
							...
							<ul class="answers__list">
								<li class="answers__item answer">
									...
									<div class="answer__text">
										...
										<p>Работа сервиса оптовых заказов tamtem.ru построена так, что заказ получает только компания, которую выбрал Заказчик. Оплата контакта происходит после выбора Поставщика в качестве победителя.</p>
										<p>Сумма оплаты за контакт равна 0.10% от средней суммы сделки.</p>
									</div>
								</li>
								<li class="answers__item answer">
									<div class="answer__head">
									...
									<div class="answer__text">
										...
										<p>
											Важно! Для удобства наших пользователей возможно сформировать заказ с помощью персонального менеджера. Для этого нужно нажать кнопку “Создать заказ”, справа вверху будет кнопка “Поможем с созданием заказа” заполните поля, и менеджер свяжется с вами в удобное для вас время.
										</p>
										<ul>
											<li>После того, как вы нажмете кнопку “Разместить заказ”, заказ на покупку появится на сайте и уйдет на модерацию. До завершения процедуры модерации заказ находится во вкладке “На модерации”.</li>
											<li>Как только заказ пройдет модерацию, вам на почту придет уведомление о публикации заказа, а на сервисе он переместится во вкладку “Активные”.</li>
										</ul>
									</div>
								</li>
								<li class="answers__item answer">
									...
									<div class="answer__text">
										<p>
											В Личном кабинете в разделе “Мои заказы”, нажмите на интересующий вас заказ, и вам откроется расширенная форма заказа, где будут все предложения Поставщиков по данному заказу. #[br] Изучите предложения  и отметьте подходящее, нажав кнопку “Принять предложение”.
										</p>
									</div>
								</li>
								<li class="answers__item answer">
									...
									<div class="answer__text">
										<p>Нет, заказ отредактировать нельзя, чтобы избежать ситуаций изменения условий заказа Заказчиком после принятия предложения.</p>
									</div>
								</li>
							</ul>
						</section>
