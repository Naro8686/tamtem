...
<head>
	<title>Сервис для поставщиков оптовых товаров – TamTem</title>
	<meta charset="UTF-8" />
	...
	<meta name="title" content="Сервис для поставщиков оптовых товаров – TamTem">
	<meta name="description"
		content="здесь Вы можете бесплатно откликнуться на оптовый заказ. Контакт заказчика получает только один поставщик. Стоимость контакта составляет 0,1% от средней суммы заказа">
	<meta name="keywords"
	...
	<meta property="og:title" content="Сервис для поставщиков оптовых товаров – TamTem">
					...
					<div class="container">
						<ul class="shortabout__list">
							<li class="shortabout__item"><img class="shortabout__pic" src="images/home/shortabout-1.png">
								<p class="shortabout__cap">крупный и малый опт1</p>
							</li>
