...
<head>
	<title>Контакты сервиса оптовых заказов TamTem</title>
	<meta name="title" content="Контакты сервиса оптовых заказов TamTem">
	<meta name="description" content="Наши контакты: E-mail: team@tamtem.ru; Viber, Whatsapp, Telegram: +7 930 720 23 00; Телефон: +7 930 720 23 00. Также связаться с нами можно воспользовавшись формой на сайте.">
	<meta name="keywords" content="сервис оптовых заказов, контакты, контакты tamtem.">
	<meta property="og:type" content="website">
	<meta property="og:site_name" content="{{ url('/') }}">
	<meta property="og:title" content="Контакты сервиса оптовых заказов TamTem">
	<meta property="og:image" content="{{ url('/') }}/images/og_logo.png">
	<meta property="og:url" content="{{ url('/') }}">
	<meta property="og:description" content="Наши контакты: E-mail: team@tamtem.ru; Viber, Whatsapp, Telegram: +7 930 720 23 00; Телефон: +7 930 720 23 00. Также связаться с нами можно воспользовавшись формой на сайте.">
	<meta charset="UTF-8" />
      ...
      <div class="container mainheader__container">
        ...
        <nav class="mainmenu"><a class="mainmenu__burger">
          ...
          <ul class="mainmenu__list notablet">
            ...
            <li class="mainmenu__item"><a class="mainmenu__link animation-link-underline" href="/faq">FAQ</a></li>
            <li class="mainmenu__item"><a class="mainmenu__link animation-link-underline" href="http://blog.tamtem.ru/">Блог</a></li>
            <!--li class="mainmenu__item"><a class="mainmenu__link animation-link-underline" href="https://agent.tamtem.ru"><span class="mainmenu__link__text--blue-text">tamtem</span><span class="mainmenu__link__text--white-text">Агент</span></a></li-->
          </ul>
          <section class="modalmenu">
            ...
            <nav class="modalmenu__navigation">
              <ul class="modalmenu__menu-list">
                <li class="modalmenu__menu-item"><a class="modalmenu__menu-link" href="/lk/bids#actived">Личный кабинет</a></li>
								<li class="modalmenu__menu-item"><a class="modalmenu__menu-link" href="/bids/">Заказы</a></li>
								<li class="modalmenu__menu-item"><a class="modalmenu__menu-link" href="/!sales/">Оптовые объвления</a></li>
                <li class="modalmenu__menu-item"><a class="modalmenu__menu-link" href="/faq">FAQ</a></li>
                <li class="modalmenu__menu-item"><a class="modalmenu__menu-link" href="http://blog.tamtem.ru/">Блог</a></li>
              </ul>
            </nav>
            <footer class="modalmenu__footer">
              <ul class="modalmenu__footer-list">
                ...
                <li class="modalmenu__footer-item"><a class="modalmenu__footer-link" href="mailto:team@tamtem.ru">team@tamtem.ru</a></li>
                <li class="modalmenu__footer-item"><a class="modalmenu__footer-link" href="tel:+79307202300">+7 930 720 23 00</a></li>
              </ul>
            </footer>
          </section>
        </nav>
        <section class="createorder mainheader__createorder"><a class="createorder__btn" href="/newbid">Создать Заказ</a></section>
          ...
          <div class="profile__section">
            <section class="profilemodal profilemodal--unlogged">
              <div class="profilemodal__box profilemodal__accountmenu accountmenu">
                <div class="accountmenu__profile"><a class="accountmenu__office" href="/lk/bids#actived">Личный кабинет</a></div>
              </div>
            </section>
            <div class="profile__box">
                  ...
                  <g>
                    ...
                    <g clip-path="url(#a)">
                      <g fill="none" stroke="#fff" stroke-linecap="round" stroke-width="1.5">
                        ...
                        <g>
                          <path d="M18.642 21.869A12.752 12.752 0 0131.39 34.621v2.834H5.89v-2.834a12.752 12.752 0 0112.752-12.752z" stroke="none"></path>
                          <path d="M18.642 22.619h0a12 12 0 0112 12v1.45a.632.632 0 01-.632.632H7.272a.632.632 0 01-.632-.632v-1.448a12 12 0 0112.002-12.002z"></path>
                        </g>
                      </g>
                    </g>
                  </g>
              ...
              <div class="profile__content notablet"><span class="profile__enter-box"><a class="profile__enter" href="/lk/bids#actived">Личный кабинет</a></span></div>
            </div>
          </div>
        </section>
      </div>
				...
				<div class="container contacts__container">
					...
					<div class="contacts__content">
						<div class="contacts__email">
							<p class="contacts__cap">Пишите</p><a class="contacts__info"
								href="mailto:team@tamtem.ru">team@tamtem.ru</a>
								...
								<ul class="messengers-list">
									<li><svg id="Group_17030" data-name="Group 17030" xmlns="http://www.w3.org/2000/svg" width="13.458"
											...
											<path id="Path_18042" data-name="Path 18042"
												...
												transform="translate(-411.797 -412.656)" fill="#000000" />
											<path id="Path_18043" data-name="Path 18043"
												...
												transform="translate(-471.739 -476.691)" fill="#000000" />
										</svg>
									</li>
									<li><svg id="Group_17031" data-name="Group 17031" xmlns="http://www.w3.org/2000/svg" width="13.035"
											...
											<path id="Path_18044" data-name="Path 18044"
												...
												transform="translate(-418.589 -415.533)" fill="#000000" />
											<path id="Path_18045" data-name="Path 18045"
												...
												transform="translate(-473.325 -467.08)" fill="#000000" />
											<path id="Path_18046" data-name="Path 18046"
												...
												transform="translate(-527.852 -460.593)" fill="#000000" />
											<path id="Path_18047" data-name="Path 18047"
												...
												transform="translate(-532.925 -475.363)" fill="#000000" />
											<path id="Path_18048" data-name="Path 18048"
												...
												transform="translate(-537.124 -490.501)" fill="#000000" />
										</svg>
									</li>
									<li><svg xmlns="http://www.w3.org/2000/svg" width="14.88" height="12.589" viewBox="0 0 14.88 12.589">
											<path id="Path_18052" data-name="Path 18052"
												...
												transform="translate(-283.999 -323)" fill="#000000" />
										</svg>
									</li>
								</ul><a class="contacts__messengers-phone contacts__info" href="tel:+79307202300">+7 930 720 23 00</a>
							</div>
						</div>
						<div class="contacts__phone">
							<p class="contacts__cap">Звоните</p><a class="contacts__info" href="tel:+79307202300">+7 930 720 23 00</a>
						</div>
						<div class="contacts__address">
							<p class="contacts__cap">Юридический адрес</p><b class="contacts__info">191124, Санкт-Петербург,
								Новгородская, 19, лит. А, пом. 3Н, оф. 8</b>
						</div>
						<div class="contacts__req">
							<div class="contacts__inn contacts__req-item">
								<p class="contacts__cap">ИНН</p><b class="contacts__info">7842166070</b>
							</div>
							<div class="contacts__ogrn contacts__req-item">
								<p class="contacts__cap">ОГРН</p><b class="contacts__info">1187847338920</b>
							</div>
						</div>
						<div class="contacts__connect"><a href="tel:+79307202300">Связаться с нами</a></div>
						<ul class="contacts__socials socials">
							<li><a class="socials__link" href="https://vk.com/tamtem_b2b?roistat_visit=102953">vkontakte</a></li>
							<li><a class="socials__link"
									href="https://ok.ru/group/54744477925527?roistat_visit=102953">odnoklassniki</a></li>
							<li><a class="socials__link"
									href="https://www.facebook.com/%D0%A2%D0%B0%D0%BC%D0%A2%D0%B5%D0%BC-417576149054496/?roistat_visit=102953">facebook</a>
							</li>
							<li><a class="socials__link"
									href="https://www.instagram.com/tamtemb2b/?roistat_visit=102953">instagram</a></li>
						</ul>
					</div>
				</div>
			</section>
      ...
      <section class="mainfooter__content">
        <div class="container mainfooter__container">
          ...
          <ul class="mainfooter__services mainfooter__list">
						<li><a class="animation-link-underline" href="/newbid">Создать Заказ</a></li>
						<li><a class="animation-link-underline" href="/newsell">Создать Объявление</a></li>
          ...
          <div class="mainfooter__contacts">
            ...
            <div class="mainfooter__contacts-cap mainfooter__messengers"><span>Пишите</span>
              <ul class="messengers-list">
                ...
                <li><svg id="Group_17031" data-name="Group 17031" xmlns="http://www.w3.org/2000/svg" width="13.035" height="13.473" viewBox="0 0 13.035 13.473">
</svg>
                </li>
                <li><svg xmlns="http://www.w3.org/2000/svg" width="14.88" height="12.589" viewBox="0 0 14.88 12.589">
<path id="Path_18052" data-name="Path 18052" d="M298.649,323.345a.966.966,0,0,0-.767-.345,1.5,1.5,0,0,0-.535.106l-12.6,4.808c-.668.255-.758.638-.753.843s.117.583.8.8l.012,0,2.613.748,1.413,4.04a1.22,1.22,0,0,0,1.129.893,1.336,1.336,0,0,0,.9-.385l1.616-1.488,2.344,1.887h0l.022.018.006,0a1.353,1.353,0,0,0,.823.309h0a1.155,1.155,0,0,0,1.1-1.023l2.064-10.19a1.217,1.217,0,0,0-.2-1.031ZM288.3,330.167l5.041-2.575-3.139,3.335a.436.436,0,0,0-.106.194l-.605,2.451Zm1.98,4.049c-.021.019-.042.036-.063.052l.562-2.274,1.021.822Zm7.713-10.014-2.064,10.19c-.02.1-.083.324-.246.324a.508.508,0,0,1-.286-.124l-2.656-2.139h0l-1.58-1.273,4.539-4.823a.436.436,0,0,0-.516-.687l-7.465,3.814-2.648-.758,12.592-4.807a.639.639,0,0,1,.224-.049c.027,0,.074,0,.092.025a.416.416,0,0,1,.016.306Zm0,0" transform="translate(-283.999 -323)" fill="#fff"/>
</svg>
                </li>
              </ul>
...
<path id="Path_13" data-name="Path 13" d="M137.072,188.77a8.711,8.711,0,0,1-3.146,2.093,14.427,14.427,0,0,1-3.568.823c.183.206.27.307.385.426,1.653,1.709,3.313,3.411,4.959,5.126a1.725,1.725,0,0,1,.369,1.988,1.953,1.953,0,0,1-1.836,1.179,1.771,1.771,0,0,1-1.162-.611c-1.246-1.291-2.518-2.562-3.74-3.877-.357-.384-.527-.31-.841.021-1.254,1.33-2.53,2.641-3.812,3.941a1.566,1.566,0,0,1-1.931.356,2.015,2.015,0,0,1-1.127-1.849,1.881,1.881,0,0,1,.606-1.243q2.454-2.52,4.9-5.05c.109-.112.21-.231.367-.405a10.95,10.95,0,0,1-5.951-2.185c-.213-.172-.433-.339-.627-.53a1.773,1.773,0,0,1-.233-2.473,1.668,1.668,0,0,1,2.25-.52,3.589,3.589,0,0,1,.495.3,9.519,9.519,0,0,0,10.811.1,2.915,2.915,0,0,1,1.053-.56,1.63,1.63,0,0,1,1.894.779,1.683,1.683,0,0,1-.113,2.17Z" transform="translate(-120.288 -170.876)" fill="#2fc06e" fill-rule="evenodd"/>
            ...
            <li><a class="mainfooter__socials-link mainfooter__socials-link--fb" href="https://www.facebook.com/%D0%A2%D0%B0%D0%BC%D0%A2%D0%B5%D0%BC-417576149054496/?roistat_visit=102953"><svg xmlns="http://www.w3.org/2000/svg" width="12.311" height="29.549" viewBox="0 0 12.311 29.549">
<g id="Векторный_смарт-объект" data-name="Векторный смарт-объект" transform="translate(0)">
<path id="Path_15" data-name="Path 15" d="M116.369,175.929h-3.652v14.8h-5.533v-14.8h-2.631v-5.2h2.631v-3.366c0-2.407,1.033-6.177,5.583-6.177l4.1.02v5.05h-2.973c-.488,0-1.174.27-1.174,1.417v3.063h4.137Zm0,0" transform="translate(-104.552 -161.182)" fill="#2fc06e"/>
</g>
</svg></a></li>
            <li><a class="mainfooter__socials-link mainfooter__socials-link--inst" href="https://www.instagram.com/tamtemb2b/?roistat_visit=102953"><svg xmlns="http://www.w3.org/2000/svg" width="25.855" height="25.854" viewBox="0 0 25.855 25.854">
