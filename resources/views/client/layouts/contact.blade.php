...
<head>
	<title>{{$metaData->title ?? 'Контакты оптовой компании Tantem'}}</title>
	<!-- Meta data -->
	<meta name="title"
		  content="{{$metaData->title ?? 'Контакты оптовой компании Tantem'}}">
...
<body>
	<div class="page-wrapper">
      ...
      <div class="container mainheader__container">
            ...
            <nav class="modalmenu__navigation">
              <ul class="modalmenu__menu-list">
                <li class="modalmenu__menu-item"><a class="modalmenu__menu-link" href="/lk/bids#actived">Личный кабинет</a></li>
								...
								<li class="modalmenu__menu-item"><a class="modalmenu__menu-link" href="/optovyye-obyavleniya/sales/">Оптовые объвления</a></li>
        ...
        <section class="createorder mainheader__createorder"><a class="createorder__btn" href="/newbid" onclick="ym(76387882,'reachGoal','sozdzaknn')">Создать Заказ</a></section>
