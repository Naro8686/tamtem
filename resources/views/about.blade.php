...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1">
				<meta name="title" content="Дополнительный доход без вложений для физических лиц">
				<meta name="description" content="Как иметь пассивный доход без вложений и пирамид?">
				<meta name="keywords" content="бизнес контакты, дополнительный доход,способ пассивного дохода, легкие деньги, деньги на бизнесе">
				<meta property="og:type" content="website">
				<meta property="og:site_name" content="{{ url('/') }}">
				<meta property="og:title" content="Дополнительный доход без вложений для физических лиц">
				<meta property="og:image" content="{{ url('/') }}/images/og_logo.png">
				<meta property="og:url" content="{{ url('/') }}">
				<meta property="og:description" content="Как иметь пассивный доход без вложений и пирамид?">
							...
							<section class="modalmenu">
								...
								<nav class="modalmenu__navigation">
									<ul class="modalmenu__menu-list">
										...
										<li class="modalmenu__menu-item"><a class="modalmenu__menu-link" href="/about">О Сервисе</a></li>
	...
	<div class="content-wrap">
		<div class="home">
					<header class="header__firtscreen">
							<div class="container header__containerfirstscreen">
									<div class="header-content">
											<h2 class="header__title-firtscreen">Больше людей -<br /> больше возможностей </h2>
											<p class="header__desc">Получайте доход за регистрацию компаний</p>
									</div>
									<div class="header-pic"><img src="{{asset ('/forblades/img/about/header-pic.png') }}" alt="peoples" /></div>	
							</div>
					</header>
		</div>
		<section class="whatis">
   	<div class="container whatis__container">
      <div class="whatis__item whatis__item--right">
         <div class="whatis__pic"><img src="/forblades/img/about/whatis-1.png" alt="what-is-tamtem"></div>
         <div class="whatis__content">
            <h2 class="whatis__cap">Что такое сервис agent.tamtem.ru</h2>
            <div class="whatis__text">
               <p>Это сервис для физических лиц, которые могут привлекать компании для работы в сервисе tamtem.ru и получать прибыль от активности данных компаний.</p>
               <p>Каждый может выступить в роли агента, рекомендовать поставщиков и заказчиков друг другу и зарабатывать на этом.</p>
            </div>
            <ul class="whatis__list">
               <li>
                  <p>Сервис agent.tamtem.ru не берет деньги с пользователей, для агентов использование сервиса <span>бесплатно</span></p>
               </li>
               <li>
                  <p>Для каждого заказа мы предлагаем <span>список</span> поставщиков, которых вы сможете привлечь для выполнения сделок</p>
               </li>
						</ul>
				</div>	
		</div>
		<div class="whatis__item whatis__item--left">
				<div class="whatis__pic"><img src="/forblades/img/about/whatis-2.png" alt="what-is-agenttamtem"></div>
				<div class="whatis__content">
					<h2 class="whatis__cap">Что такое сервис tamtem.ru</h2>
						<div class="whatis__text">
							<p>Это B2B биржа оптовых заказов.</p>
							<p>Мы работаем по системе краудсорсинга, а его эффективность в несколько раз превышает эффективность обычного поиска, потому что позволяет в короткие сроки охватить максимальное количество людей и компаний.</p>
							<p>В нашем случае, мы гарантируем короткий цикл сделки и ее реализацию. Стоимость получения контактов для поставщика - 0,2% от средней суммы сделки, разместить заказ и оставить отклик – бесплатно.</p>
						</div>
				</div>
			</div>	
		</section>
		<section class="increasetwo">
			<div class="container increase__container">
					<h1 class="increasetwo__cena">50₽</h1>
					<h2 class="increasetwo__title">за регистрацию каждой <br> компании по предложенному списку</h2>
					<p class="example__provider-txt">*Вывод денежных средств осуществляется с помощью Яндекс.Деньги на любую банковскую карту в РФ от 100 рублей</p>
					<div class="example__provider">
							<div class="example__provider-pic"><img src="/forblades/img/about/yandex-money.jpg" alt="yandex-money"></div>
					</div>
			</div>
		</section>
		<section class="howto">
    <div class="container howto__container">
        <h2 class="howto__title">Как начать работать</h2>
        <ul class="howto__list">
            <li>
                <div class="howto__pic"><img src="/forblades/img/about/step-1.png" alt="Перейдите по ссылке"></div><strong class="howto__cap">1. Зарегистрируйтесь</strong>
                <p class="howto__txt">Перейдите по ссылке в нашу группу Вконтакте и найдите реферальную ссылку для регистрации</p>
            </li>
            <li>
                <div class="howto__pic"><img src="/forblades/img/about/step-2.png" alt="Выберите заказ"></div><strong class="howto__cap">2. Выберите заказ</strong>
                <p class="howto__txt">Из списка поставщиков сгенерируйте ссылки. Отправьте готовую ссылку для регистрации представителю компании любым удобным способом.</p>
            </li>
            <li>
                <div class="howto__pic"><img src="/forblades/img/about/step-3.png" alt="Свяжитесь с поставщиками"></div><strong class="howto__cap">3. Свяжитесь с поставщиками</strong>
                <p class="howto__txt">Как только компания зарегистрируется по вашей ссылке, она попадет в ваш Портфель компаний. Каждая сделка компании из вашего Портфеля приносит вам доход.</p>
            </li>
        </ul>
    </div>
		</section>
		<section class="increasetwo">
    <div class="container increase__container">
        <h2 class="increasetwo__title">Честная сделка</h2>
        <p class="increasetwo__text">Найди поставщика под заказ и получи доход</p>
        <h1 class="increasetwo__cena">5%</h1>
        <p class="increasetwo__textvyplata">от выплат компаниями из вашего портфеля сервису tamtem.ru </p>
        <p>*Начиная с Золотого статуса</p>
    </div>
		</section>
		<section class="reviews">
    <div class="container reviews__container">
        <h2 class="reviews__title">СМИ о нас</h2>
        <div class="reviews__wrapper">
            <ul class="reviews__list">
                <li class="reviews__box">
                    <a href="https://wall.wayxar.ru/startups/kak_effektivnee_rabotat_s_poiskom_zakazchikov_i_postavshchikov" class="reviews__item">
                        <p class="reviews__text">О нашем стартапе пишут в новостном издании и рассказывают о работе сервиса для заказчиков по поиску поставщиков</p>
                        <p class="reviews__link"><span>Читать</span><i><svg data-v-072ca9b2="" xmlns="http://www.w3.org/2000/svg" width="17.371" height="10.827" viewBox="0 0 17.371 10.827"><g data-v-072ca9b2="" id="Group_15935" data-name="Group 15935" transform="translate(-51.432 1.061)"><g data-v-072ca9b2="" id="Group_15362" data-name="Group 15362" transform="translate(52.182)"><g data-v-072ca9b2="" id="Group_15361" data-name="Group 15361"><path data-v-072ca9b2="" id="Path_17471" data-name="Path 17471" d="M5317.334,2239.2l4.351-4.353-4.351-4.352" transform="translate(-5305.815 -2230.49)" fill="none" stroke="#2fc06e" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5"></path><line data-v-072ca9b2="" id="Line_680" data-name="Line 680" x1="15.817" transform="translate(0 4.329)" fill="none" stroke="#2fc06e" stroke-linecap="round" stroke-miterlimit="10" stroke-width="1.5"></line></g></g></g></svg></i><span class="reviews__resname">wall.wayxar.ru	</span></p>
                    </a>
                </li>
                <li class="reviews__box">
                    <a href="https://www.e-xecutive.ru/career/hr-management/1991542-kak-ne-pereplatit-programmistu" class="reviews__item">
                        <p class="reviews__text">Наш технический директор рассказывает как правильно подобрать программистов. Экспертное мнение для журнала e-xecutive.ru</p>
                        <p class="reviews__link"><span>Читать</span><i><svg data-v-072ca9b2="" xmlns="http://www.w3.org/2000/svg" width="17.371" height="10.827" viewBox="0 0 17.371 10.827"><g data-v-072ca9b2="" id="Group_15935" data-name="Group 15935" transform="translate(-51.432 1.061)"><g data-v-072ca9b2="" id="Group_15362" data-name="Group 15362" transform="translate(52.182)"><g data-v-072ca9b2="" id="Group_15361" data-name="Group 15361"><path data-v-072ca9b2="" id="Path_17471" data-name="Path 17471" d="M5317.334,2239.2l4.351-4.353-4.351-4.352" transform="translate(-5305.815 -2230.49)" fill="none" stroke="#2fc06e" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5"></path><line data-v-072ca9b2="" id="Line_680" data-name="Line 680" x1="15.817" transform="translate(0 4.329)" fill="none" stroke="#2fc06e" stroke-linecap="round" stroke-miterlimit="10" stroke-width="1.5"></line></g></g></g></svg></i><span class="reviews__resname">e-xecutive.ru	</span></p>
                    </a>
                </li>
                <li class="reviews__box">
                    <a href="https://businesstory.ru/my-soedinjaem-biznes-i-obshhestvo-istorija-platformy-tamtem-ru/" class="reviews__item">
                        <p class="reviews__text">Артём Ковалев, генеральный директор ООО «Акстек» (интернет-сервис agent.tamtem.ru), рассказал BS, каким должен быть социальный бизнес, почему для малого бизнеса важны рекомендации</p>
                        <p class="reviews__link"><span>Читать</span><i><svg data-v-072ca9b2="" xmlns="http://www.w3.org/2000/svg" width="17.371" height="10.827" viewBox="0 0 17.371 10.827"><g data-v-072ca9b2="" id="Group_15935" data-name="Group 15935" transform="translate(-51.432 1.061)"><g data-v-072ca9b2="" id="Group_15362" data-name="Group 15362" transform="translate(52.182)"><g data-v-072ca9b2="" id="Group_15361" data-name="Group 15361"><path data-v-072ca9b2="" id="Path_17471" data-name="Path 17471" d="M5317.334,2239.2l4.351-4.353-4.351-4.352" transform="translate(-5305.815 -2230.49)" fill="none" stroke="#2fc06e" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5"></path><line data-v-072ca9b2="" id="Line_680" data-name="Line 680" x1="15.817" transform="translate(0 4.329)" fill="none" stroke="#2fc06e" stroke-linecap="round" stroke-miterlimit="10" stroke-width="1.5"></line></g></g></g></svg></i><span class="reviews__resname">businesstory.ru	</span></p>
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="reviews__wrapper">
            <ul class="homepage-feedbacks__list">
                <li class="homepage-feedbacks__item">
                    <div class="homepage-feedbacks__card feedback-card"></div>
                    <p class="feedback-card__name">Марина Смирнова</p>
                    <div class="feedback-card__stars">
                        <ul class="rate">
                            <li class="rate__item rate__item--active">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20.758" height="19.779" viewBox="0 0 20.758 19.779">
                                    <defs>
                                        <linearGradient id="linear-gradient" x1="0.5" y1="0.02" x2="0.5" y2="1.096" gradientUnits="objectBoundingBox">
                                            <stop offset="0" stop-color="#2fc06e"></stop>
                                            <stop offset="1" stop-color="#48c3c2"></stop>
                                        </linearGradient>
                                    </defs>
                                    <g id="Group_23596" data-name="Group 23596" transform="translate(0)">
                                        <path id="Path_42004" data-name="Path 42004" d="M1149.979,679.218c.261-.538.688-.538.949,0l2.387,4.922a2.281,2.281,0,0,0,1.551,1.128l5.419.75c.592.082.725.488.294.9l-3.943,3.791a2,2,0,0,0-.593,1.824l.962,5.385c.105.59-.24.84-.768.559l-4.824-2.579a2.276,2.276,0,0,0-1.918,0l-4.825,2.579c-.527.281-.872.031-.767-.559l.961-5.385a2.276,2.276,0,0,0-.593-1.824l-3.943-3.791c-.43-.416-.3-.821.294-.9l5.418-.75a2.283,2.283,0,0,0,1.553-1.128Z" transform="translate(-1140.075 -678.815)" fill="url(#linear-gradient)"></path>
                                    </g>
                                </svg>
                            </li>
                            <li class="rate__item rate__item--active">
                    ...
                    <div class="feedback-card__text">
                        <p>Это просто и доступно для любого человека. Никаких вложений, а вывести деньги смог сразу же после поступления на кошелек в agent.tamtem.ru. Да, сначала получается не очень много, но сделать несколько активных компаний, а потом с них получать дополнительный доход можно легко. Проект полностью легален, это тот плюс, который я отметил для себя. </p>
                    </div>
                </li>
                <li class="homepage-feedbacks__item">
                    <div class="homepage-feedbacks__card feedback-card"></div>
                    <p class="feedback-card__name">Елена Грищенкова</p>
                    <div class="feedback-card__stars">
                        <ul class="rate">
                            <li class="rate__item rate__item--active">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20.758" height="19.779" viewBox="0 0 20.758 19.779">
                    ...
                    <div class="feedback-card__text">
                        <p>Пришлось изрядно попотеть мозгами, чтобы окончательно разобраться в сервисе. Промежуточный итог - 160 баллов начислено, зарегистрировано уже почти 20 компаний. Две из них провели оплату. Еще не выводил, коплю сумму посущественнее. Буду привлекать активных партнеров-агентов. Тема интересная.
                            <br>
                            <br> Считаю, что не зря залетел на именно на старте. Долгосроки - мое все) Чуть не забыл упомянуть техподдержку... Ох, ребятам, видимо, нелегко приходится. Это я еще такой адекватный и более-менее разобрался сам. Представляю, сколько халявщиков им пишет. Держитесь! Сам был на вашем месте. А пока работаем, товарищи)</p>
                    </div>
                </li>
                <li class="homepage-feedbacks__item">
                    <div class="homepage-feedbacks__card feedback-card"></div>
                    <p class="feedback-card__name">Елена Воронина</p>
                    <div class="feedback-card__stars">
                        <ul class="rate">
                            <li class="rate__item rate__item--active">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20.758" height="19.779" viewBox="0 0 20.758 19.779">
                    ...
                    <div class="feedback-card__text"></div>
                    <p>Это реально выгодный сервис. На данный момент интернет перенасыщен различными биржами, сайтами, сервисами, которые обещают золотые горы, а в итоге заработать на них можно копейки. На данном сайте, по крайней мере, все честно и легально.
                        <br>
                        <br> Выплаты осуществляются стабильно. Да, с самого начала можно не ждать золотых гор, нужно немного времени вникнуть, и начать собственное развитие.
                        <br>
                        <br> Хорошо что сервис не требует постоянного нахождения на нем, можно использовать его как второстепенный заработок, и подрабатывать примерно 2, 3, 4 часа в день при этом иметь неплохую, стабильную, и даже со временем, пассивную прибыль!</p>
                </li>
            </ul>
        </div>
    </div>
