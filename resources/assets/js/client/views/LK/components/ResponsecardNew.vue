        ...
        .response_second_block_left
          .response_info
            p
              ...
              span.response_span_date {{dateTimeformat(dateTimezone(response.dateCreated))}}
            p.price_p
    ...
    .response_body
      .response_body_content
        .response_body_left
          ...
          ul
            li(v-for="answer in sortSequence", :class="{ 'not-agree': !response.answers[answer].is_agree }")
