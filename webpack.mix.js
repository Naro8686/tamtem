...
mix
  ...
  .sass(
    "resources/assets/sass/client/blades/mainblades.scss",
    "public/blades/styles/layout.css"
  )
  .sass("resources/assets/sass/admin.scss", "public/css/admin.css")
  .copy("resources/assets/images", "public/images/", false)
  .copy("resources/assets/blades", "public/blades/", false)
  .copy("resources/assets/inroot", "public/", false)
  .copy("resources/assets/files", "public/files/", false)
      ...
      resolve: {
        alias: {
          ...
          styleguide: path.join(
            __dirname,
            "resources/assets/sass/styleguide.scss"
          ),
          mixins: path.join(__dirname, "resources/assets/sass/mixins.scss")
        }
      }
    };
  })
