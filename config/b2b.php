...
return [
    ...
    'email' => [
        ...
        'callme' => env('B2B_EMAIL_CALLME', 'all_register@tamtem.ru'),
        'managers' => env('B2B_EMAIL_MANAGERS', 'all_register@tamtem.ru'),
        'shan_it_dir' => env('B2B_EMAIL_SHAN_IT_DIR', 'all_register@tamtem.ru'),
    ],
    ...
    'data_logger' => [
        'data_logger_active' => true,
        'data_logger_use_db' => false,
    ],
    ...
    'permissions' => [
        ...
        'dealquestion' => [
            'name' => 'Заголовки вопросов к сделкам',
            'slug' => 'dealquestion',
            'permissions' => [
                'show', 'create', 'edit', 'delete',
            ],
