...
class TamtemAPIController extends Controller
{
...
$organization = Organization::where('inn', '=', $request->inn)-> where('status', '=', Organization::ORGANIZATION_STATUS_UNACTIVATED)->orderBy('created_at', 'DESC')->first();
				if($organization){
