...
class DialogItemFormatter
{
        ...
        return empty($item)
            ...
            : collect([
                ...
                'last_message'            => $item->last_message
                    ? $item->last_message->message : null,
                'last_message_date'       => $item->last_message
                    ? $item->last_message->created_at : $item->created_at,
                'deal'                    => [
                    'id'   => $item->deal->id,
                    'name' => $item->deal->name,
                ],
                'organization'            => ($item->seller->id
                    !== $this->myOrg)
                    ? [
                        'id'   => $item->seller->id,
    ...
    public function formatPaginator($paginator, $myOrg = null, $myUserId = null)
    {
