...
class Organization extends Model
{
    ...
    protected $dates = ['deleted_at', 'org_registration_date'];
    ...
    {
        return $this->belongsToMany(\App\Models\Org\Tag::class)->withTimestamps();
    }

    /**
     *  Get the channels notify associated with the given organization
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    public function channels()
    {
        return $this->belongsToMany(\App\Models\Org\Channel::class, 'organization_channel')->withTimestamps();
    }
    ...
    {
        return $this->hasMany(\App\Models\Org\OrganizationDealMember::class, 'organization_id');
    }
    ...
    {
        return $this->responses()->where('trading_status', "<>", OrganizationDeal::DEAL_TRADING_STATUS_NA)
    ...
    {
        return $this->hasOne(\App\Models\Org\OrganizationStatistic::class, 'organization_id');
    }
